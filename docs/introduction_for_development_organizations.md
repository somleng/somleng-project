...
Since the beginning of the project Somleng has processed around [233 K](http://rtd.somleng.org) minutes worth of registrations and [81.1 K](http://rtd.somleng.org) minutes worth of alerts, resulting in a total cost saving of around [$8,105.69](http://rtd.somleng.org) if [compared with Twilio](https://www.twilio.com/voice/pricing/kh).
