...
Since the beginning of the project Somleng has processed around [268 K](http://rtd.somleng.org) minutes worth of registrations and [83.5 K](http://rtd.somleng.org) minutes worth of alerts, resulting in a total cost saving of [$8,350.59 (100%)](http://rtd.somleng.org) if [compared with Twilio](https://www.twilio.com/voice/pricing/kh).
