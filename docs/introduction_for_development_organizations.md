...
Since the beginning of the project Somleng has processed around [310 K](http://rtd.somleng.org) minutes worth of registrations and [83.6 K](http://rtd.somleng.org) minutes worth of alerts, resulting in a total cost saving of [$8,354.09 (100%)](http://rtd.somleng.org) if [compared with Twilio](https://www.twilio.com/voice/pricing/kh).
