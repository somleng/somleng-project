...
Since the beginning of the project Somleng has processed around [256 K](http://rtd.somleng.org) minutes worth of registrations and [83.4 K](http://rtd.somleng.org) minutes worth of alerts, resulting in a total cost saving of around [$8,339.39](http://rtd.somleng.org) if [compared with Twilio](https://www.twilio.com/voice/pricing/kh).
