...
Since the beginning of the project Somleng has processed around [316 K](http://rtd.somleng.org) minutes worth of registrations and [85.9 K](http://rtd.somleng.org) minutes worth of alerts, resulting in a total cost saving of [$8,584.59 (100%)](http://rtd.somleng.org) if [compared with Twilio](https://www.twilio.com/voice/pricing/kh).
