...
Since the beginning of the project Somleng has processed around [353 K](http://rtd.somleng.org) minutes worth of registrations and [93.4 K](http://rtd.somleng.org) minutes worth of alerts, resulting in a total cost saving of [$9,336.29 (100%)](http://rtd.somleng.org) if [compared with Twilio](https://www.twilio.com/voice/pricing/kh).
