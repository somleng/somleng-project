locals {
  somleng_adhearsion_app_identifier = "somleng_adhearsion"
}
...
resource "aws_elastic_beanstalk_environment" "somleng_adhearsion_webserver" {
  ...
  setting {
    namespace = "aws:elasticbeanstalk:application:environment"
    name      = "AHN_CORE_HOST"
    value     = "freeswitch.internal.farmradio.io"
  }
  setting {
    namespace = "aws:elasticbeanstalk:application:environment"
    name      = "AHN_CORE_PORT"
  ...
  setting {
    ...
    value     = "https://admin:${aws_ssm_parameter.twilreapi_internal_api_password.value}@twilreapi.farmradio.io/api/internal/phone_calls"
  }
  setting {
    namespace = "aws:elasticbeanstalk:application:environment"
    name      = "AHN_TWILIO_REST_API_PHONE_CALL_EVENTS_URL"
    value     = "https://admin:${aws_ssm_parameter.twilreapi_internal_api_password.value}@twilreapi.farmradio.io/api/internal/phone_calls/:phone_call_id/phone_call_events"
  }
}